...
public:
   ...
   * and in2.
   *
   * This is a modification of the original addition filter, adding the color of
   *the
...
private:
  static uint8_t add_lut[511]; // look-up table storing values to do a quick MAX
                               // of two values when you know you add two
                               // unsigned chars
};
