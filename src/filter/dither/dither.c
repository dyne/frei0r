...
f0r_instance_t f0r_construct(unsigned int width, unsigned int height)
{
  ...
  inst->width    = width;
  inst->height   = height;
  inst->levels   = 5.0 / 48.0; // input range 0.0 - 1.0 will be interpreted as
                               // levels range 2 - 50
  inst->matrixid = 1.0;        // input range 0.0 - 1.0 will be interpreted as
                               // matrixid 0 - 9
                               // e.g. values 0.0, 0.12, 0.23, 0.34, 0.45, 0.56,
                               // 0.67, 0.78, 0.89, 1.0
