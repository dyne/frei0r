 ...
 * to 16:9 and maintain the original aspect ratio in the center part of the
 * image.
 */
...
private:
  ...
  void updateScalingFactors()
  {
    ...
    // validate if resulting borders are still within the valid range for later
    // calculations [1,width-1]
