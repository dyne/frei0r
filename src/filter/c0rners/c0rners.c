...
int premica2d(tocka2 t1, tocka2 t2, premica2 *p)
{
  ...
  p->b = -1.0 / dy;
  p->c = t1.y / dy - t1.x / dx;
  m    = 1.0 / sqrtf(p->a * p->a + p->b * p->b); if (p->c >= 0)
  {
    m = -m;
  }
  p->sa = m * p->a;
...
void make_alphamap(unsigned char *amap, tocka2 vog[], int wo, int ho, float *map, float feath, int nots[])
{
  ...
  for (i = 0; i < ho; i++)
  {
    for (j = 0; j < wo; j++)
    {
      ...
      rmin = 1.0E22;
      if ((r12 < rmin) && (nots[0] != 1))
      {
        rmin = r12;
      }
      if ((r23 < rmin) && (nots[1] != 1))
      {
        rmin = r23;
      }
      if ((r34 < rmin) && (nots[2] != 1))
      {
        rmin = r34;
      }
      if ((r41 < rmin) && (nots[3] != 1))
      {
        rmin = r41;
      }
...
int geom4c_b(int wi, int hi, int wo, int ho, tocka2 vog[], int str, float strx, float stry, float *map, int nots[])
{
  ...
  int      tip;                //1=degen trik 2=paral 3=splosni 4=twist
                               // 5=konkavni
  int      i;
  ...
  if (t12 == -10)
  {
    R = vog[0]; p12 = p34; p1 = -1; tip = 1;
  }
  if (t34 == -10)
  {
    R = vog[2]; p34 = p12; p1 = -1; tip = 1;
  }
  if (t41 == -10)
  {
    S = vog[0]; p41 = p23; p2 = -1; tip = 1;
  }
  if (t23 == -10)
  {
    S = vog[2]; p23 = p41; p2 = -1; tip = 1;
  }
  ...
  if (fabsf(p41.a) > fabsf(p41.b))      //bolj pokonci
  {
    if (((R.y - vog[3].y) * (R.y - vog[0].y)) < 0.0)
    {
      r41 = 1;
    }
  }                                                      //R na 4-1
  ...
  {
    if (((R.x - vog[3].x) * (R.x - vog[0].x)) < 0.0)
    {
      r41 = 1;
    }
  }                                     //R na 4-1
  ...
  if (fabsf(p23.a) > fabsf(p23.b))      //bolj pokonci
  {
    if (((R.y - vog[1].y) * (R.y - vog[2].y)) < 0.0)
    {
      r23 = 1;
    }
  }                                                      //R na 2-3
  ...
  {
    if (((R.x - vog[1].x) * (R.x - vog[2].x)) < 0.0)
    {
      r23 = 1;
    }
  }                                     //R na 2-3
  ...
  if (fabsf(p12.a) > fabsf(p12.b))      //bolj pokonci
  {
    if (((S.y - vog[0].y) * (S.y - vog[1].y)) < 0.0)
    {
      s12 = 1;
    }
  }                                                      //S na 1-2
  ...
  {
    if (((S.x - vog[0].x) * (S.x - vog[1].x)) < 0.0)
    {
      s12 = 1;
    }
  }                                     //S na 1-2
  ...
  if (fabsf(p34.a) > fabsf(p34.b))      //bolj pokonci
  {
    if (((S.y - vog[2].y) * (S.y - vog[3].y)) < 0.0)
    {
      s34 = 1;
    }
  }                                                      //S na 3-4
  ...
  {
    if (((S.x - vog[2].x) * (S.x - vog[3].x)) < 0.0)
    {
      s34 = 1;
    }
  }                                                      //S na 3-4
...
void f0r_get_param_value(f0r_instance_t instance, f0r_param_t param, int param_index)
{
  ...
  case 11:                                                      //Interpolation
    *((double *)param) = map_value_backward(p->intp, 0.0, 6.0); //!!!!!! 6.999
                                                                // ???? tudi v
                                                                // defish!!!!
    break;
