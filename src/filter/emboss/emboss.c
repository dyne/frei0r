...
f0r_instance_t f0r_construct(unsigned int width, unsigned int height)
{
  ...
  inst->width     = width;
  inst->height    = height;
  inst->azimuth   = 135.0 / 360.0; //input range 0 - 1 will be interpreted as
                                   // angle 0 - 360
  inst->elevation = 30.0 / 90.0;   //input range 0 - 1 will be interpreted as
                                   // lighness value 0 - 90
  inst->width45   = 10.0 / 40.0;   //input range 0 - 1 will be interpreted as
                                   // bump height value 1 - 40
